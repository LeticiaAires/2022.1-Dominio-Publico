...
Anteriormente, na etapa de Análise de requisitos, foi feita uma [Análise de tarefas](./#/analiseRequisitos/analiseTarefas), a equipe analisou o site e as tarefas que os usuários realizariam neste, porém, esse levantamento de tarefas foi realizado por análise própria dos membros do grupo, sem a interação com o usuário. 
